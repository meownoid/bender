...
class Entity[T]:
    ...
    def get_usage(self) -> str:
        ...
        lines = [
            f"{click.style(self.name, fg='green', bold=True)}: {click.style(self.description, fg='white', bold=True)}"
        ]
        ...
        for name, parameter in self.parameters.items():
            ...
            lines.append(f"  - {name_colorized}: {description_colorized} {traits_colorized}")
